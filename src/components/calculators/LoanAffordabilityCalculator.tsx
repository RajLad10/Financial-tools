...
export function LoanAffordabilityCalculator() {
  ...
  const onSubmit = (data: FormT) => {
    const r = calculateAffordableLoan(data.affordableEmi, data.interestRate, data.tenureYears);
    setRes(r);
  };
    ...
    <div className="space-y-6">
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="flex gap-3">
          <Button type="submit" disabled={isSubmitting}>Check Eligibility</Button>
